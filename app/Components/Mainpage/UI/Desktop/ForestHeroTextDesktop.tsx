...
export default function ForestHeroText({
  ...
  return (
    <div className="absolute left-1/2 top-[10%] z-20 w-full max-w-[1040px] -translate-x-1/2 text-center">
      <p
        ...
        style={{
          ...
          fontSize: "clamp(11rem, 22vw, 24rem)",
          fontWeight: 400,
        }}
      >
        {heroText.top}
...
<div
  className="my-[-0.45em] flex items-center justify-end pr-[8%]"
  style={{
